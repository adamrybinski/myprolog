...
nieruchomosc(mieszkanie_krakow, 650000).     % Mieszkanie Podarowane Paulinie w Krakowie
...
darowizna(paulina, mieszkanie_krakow, 650000). % Mieszkanie w Krakowie - Paulina
darowizna(wojtek, kasinka_mala_5_8, 390750).   % 5/8 nieruchomości w Kasince - Wojtek
darowizna(wojtek, dzialki_jablonka_polowa, 196100). % Połowa działek w Jabłonce - Wojtek
darowizna(alicja, dzialki_jablonka_polowa, 196100). % Połowa działek w Jabłonce - Alicja
...
calkowita_wartosc_spadku(CalkowitaWartosc) :-
    ...
    CalkowitaWartosc is P1 + P2 + P3 + P4 + P5 + P6 + P7.
